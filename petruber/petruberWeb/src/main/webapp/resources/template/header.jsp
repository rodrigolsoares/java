          ...
          <ul class="nav navbar-nav">
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="#">
                    <span class="glyphicon glyphicon-book" aria-hidden="true"></span>&nbsp;Importa Book Entrada</a>
                </li>
                <li role="separator" class="divider"></li>
                <li><a href="mporta_book_saida.html">
                    <span class="glyphicon glyphicon-book" aria-hidden="true"></span>
                    Importa Book Saída</a>
                </li>
              </ul>
            </li>
          ...
          <ul class="nav navbar-nav navbar-right">
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="#">Help</a></li>
                <li role="separator" class="divider"></li>
                <li><a href="#">Video Apresentação</a></li>
                <li role="separator" class="divider"></li>
                <li><a href="#">Versão Sistema</a></li>
