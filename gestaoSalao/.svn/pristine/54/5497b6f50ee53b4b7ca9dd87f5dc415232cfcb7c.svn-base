...
insert into status_atendimento (pk_status_atendimento, nm_status, ds_status)Values(4,'À Confirmar','Sinaliza todos os que agendaram o serviço via smartfone, e aguardam aprovação para mudar o status de aguardando atendimento');
...
insert into forma_pagamento(pk_forma_pagamento, nm_forma_pagamento)values(6, 'Não informado');
...
insert into menu_mobile (pk_menu, nm_menu, nm_url, nm_icone, id_obj, nivel) values (4, 'Funcionário', '#', '#', 'idFunc', 0);
...
insert into menu_mobile (pk_menu, nm_menu, nm_url, nm_icone, id_obj, nivel) values (7, 'Serviço', '#', '#', 'idServ', 0);
...
insert into menu_mobile (pk_menu, nm_menu, nm_url, nm_icone, id_obj, nivel) values (18, 'Relatórios', '#', '#', 'idRelat', 0);
...
insert into menu_mobile (pk_menu, nm_menu, nm_url, nm_icone, id_obj, nivel) values (21, 'Configurações', '#', '#', 'idConf', 0);
...
update menu set nm_menu= 'Serviço' where pk_menu = 7;
